...
def create_dialog_window_for_generator():
    def increase1():
        value = int(lbl_value["text"])
        lbl_value["text"] = f"{value + 1}"
    ...
    lbl1 = tkinter.Label(master=window, text="кол-во шаблонов по x")
    lbl2 = tkinter.Label(master=window, text="кол-во шаблонов по y")
